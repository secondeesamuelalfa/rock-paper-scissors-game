...
- **Computer AI:** Randomized computer selection for fair play
- **Score Tracking:** Real-time updates for player and computer wins
- **Dynamic UI:** Visual feedback indicating win, loss, or draw
